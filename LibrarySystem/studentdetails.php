	...
	<body style = "background-color:#d3d3d3;">
		...
		<div class = "container-fluid">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-tasks"></i> Accounts</a>
						<ul style = "list-style-type:none;">
							...
							<li><a href = "studentdetails.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-user"></i> Student Detail</a></li>
						</ul>
					</li>
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<div class = "alert alert-info">Accounts / Student Details</div>
					...
					<div id = "student_table">
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php
									$qstudent = $conn->query("SELECT * FROM `studentlogin`") or die(mysqli_error());
									while($fstudent = $qstudent->fetch_array()){
								?>
								<tr>
									<td><?php echo $fstudent['Studentno']?></td>
									<td><?php echo $fstudent['Fname']?></td>
									<td><?php echo $fstudent['Lname']?></td>
							
									<td><?php echo $fstudent['Course']?></td>
									<td><?php echo $fstudent['Section']?></td>
									<td><?php echo $fstudent['Bookname']?></td>
